...
export default function PreviewModal({ invoice, settings, onClose, onSave }: Props) {
  // Escape to close
  useEffect(() => {
  ...
  const modal = (
    <>
      {/* ── Print-only layer (invisible on screen, shows on print) ── */}
      <div
        ...
        >
          ...
          <div className="modal-toolbar" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <div style={{ fontWeight: 800, fontSize: '15px' }}>Invoice Preview</div>
                <div style={{ fontSize: '12px', opacity: 0.65, marginTop: '1px' }}>
                  #{invoice.invoiceNumber} · {invoice.customerName || 'Customer'}
                </div>
              </div>
            </div>
              ...
              {onSave && (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 700, fontSize: '13px', cursor: 'pointer', fontFamily: 'Inter, sans-serif',
                  }}
                >
          ...
          {/* ── Invoice body ── */}
          <div className="modal-body" style={{ backgroundColor: '#f0f4f8', padding: '20px' }}>
            <div style={{ backgroundColor: '#fff', borderRadius: '14px', overflow: 'hidden', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', overflowX: 'auto' }}>
      ...
      <style>{`
        ...
        @media print {
          ...
          #invoice-print-area, #invoice-print-area * { visibility: visible !important; display: block !important; }
          #invoice-print-area {
